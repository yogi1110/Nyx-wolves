...
--><style type="text/css">
    .tm-main-bg {
      background-image: url(public/img/new-vision-01.jpg);
    }
            ...
            <div class="row">
                <div class="col-12 tm-site-header-col">
                    <div class="tm-site-header-left">
                        ...
                        <h1 class="tm-site-name">Nyx Wolves
                        </h1>
                    </div>
            ...
            <section class="tm-welcome">
                ...
                <div class="row tm-welcome-row">
                    <article class="col-lg-6 tm-media">
                        <img src="{{asset('public/img/img-3x2-01.jpg')}}" alt="Welcome image" class="img-fluid tm-media-img" />
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src="{{asset('public/img/img-3x2-02.jpg')}}" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
                    ...
                    <article class="col-lg-6 tm-media">
                        <img src={{asset('public/img/img-3x2-04.jpg')}}" alt="Welcome image" class="img-fluid tm-media-img" />
                        <div class="tm-media-body">
